var container = document.querySelector('.svgMaskedContainer');
  var width = container.offsetWidth;
  var height = container.offsetHeight;
  var wave = document.getElementById('maskedWavePath');

  wave.style.position = 'fixed';
  wave.style.left = '0';
  var waveWidth = container.offsetWidth; // Wave SVG width (usually container width)
  var waveHeight = container.offsetHeight / 2.1; // Position from the top of container
  var waveDelta = 14; // Wave amplitude
  var speed = 0.2; // Wave animation speed
  var wavePoints = 10; // How many point will be used to compute our wave
